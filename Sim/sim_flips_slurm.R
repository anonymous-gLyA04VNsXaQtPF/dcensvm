# Simulation: Flips under slurm jobs in HPC 
# Section 4.5 Effect of Sign Flips 
# Analysis of label flips. We set the label flip proportion $p_{flip} in \{0.01, 0.05, 0.1\}$.  

rm(list = ls())
simulation_name <- "flips"
