# Simulation: Sparsity under slurm jobs in HPC 
# Section K.8 Effect of the Sparsity $s$
# Evaluate the performance of deCSVM and baseline methods under varying sparsity levels $s \in \{5, 10, 15, 20, 30\}$.
...
out_table <- aggregate(. ~ s + rho, result, mean)
out_table
