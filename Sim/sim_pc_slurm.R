# Simulation: pc under slurm jobs in HPC 
# Section 4.4 Effect of Topology  
# Effect of network sparsity by varying the network connection probability \(p_c \in \{0.3, 0.5, 0.8\}\). For this analysis, we fix the number of nodes to \(m = 10\), the local sample size to \(n = 200\), and the dimensionality to \(p = 100\). 
