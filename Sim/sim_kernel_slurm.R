# Simulation: Kernel type under slurm jobs in HPC 
# Section K.3 Effect of Kernel Type
# Robustness of our deCSVM across various kernel smoothing techniques, including uniform, Laplacian, logistic, Gaussian, and Epanechnikov kernels with kernel_type = 1-5 respectively.

rm(list = ls())
simulation_name <- "kernel"
